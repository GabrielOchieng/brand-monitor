...
export function NotificationBell() {
  ...
  return (
    <Link href="/notifications" className="relative text-ink-subtle hover:text-ink" aria-label="Notifications">
      ...
      {unreadCount > 0 && (
        <span className="absolute -right-2 -top-2 flex h-4 min-w-4 items-center justify-center rounded-full bg-red-600 px-1 text-[10px] font-semibold text-white ring-2 ring-base">
